...
if [ "$BASIC" = true ] ; then
    pip install pillow imageio imageio-ffmpeg tqdm easydict opencv-python-headless scipy ninja trimesh xatlas pyvista pymeshfix igraph transformers huggingface_hub huggingface_cli
